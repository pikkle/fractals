...
public class FlamePPMMaker {
	 ...
	 * @param palette La palette de couleur utilisée.
	 * @param background La couleur de fond.
	 * @param file Le fichier où l'image doit être stockée.
	 */
	private static void printer(FlameAccumulator flameAccu, Palette palette,
		...
		try {
			...
			//3 premières lignes qui indiquent que le fichier est une image .PPM
			String start = "P3\n" + flameAccu.width() + " "
					+ flameAccu.height() + "\n100";
			ps.println(start);
			...
			for (int i = 0; i < flameAccu.height(); i++) {
				...
				ps.print("\n"); // Retour à la ligne pour la ligne de pixels suivante.
			}
			ps.flush();
	...
	public static void main(String[] args){
		...
		//Turbulence
		System.out.println("Création de la fractale Turbulence...");
